...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			// 		var repwd = $("#repwd").val()
			// 		if (password!=repwd||usernameTest.test(password)){
			// 			$(".errorMsg").text("重复密码不一致")
			// 			return false
			// 		}
			// 		var email = $("#email").val()
						...
						<div class="login_box">
							...
							<div class="form">
								<form action="UserServlet" method="post">
									...
									<br />
									<label>验证码：</label>
									<input class="itxt" type="text" style="width: 150px;" name="code" id="code"value="${code}"/>
<%--									<img alt="" src="static/img/code.bmp" style="float: right; margin-right: 40px" >--%>
									<img alt="" src="http://localhost:8080/book/kaptcha.jpg" id="codeImg" style="float: right; margin-right: 40px;width: 100px;" >
									<br />
									<br />
